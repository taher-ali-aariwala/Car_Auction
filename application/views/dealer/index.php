									...
									<div class="card-body py-2 px-3">
										...
										<div class="row justify-content-between">
											...
											<div class="col-lg-7 text-center">
												...
												<a href="<?= base_url(); ?>chat/start_chat/<?= $auction->id; ?>" class="text-uppercase card-active-btn bg-success"><i class="far fa-comment-dots"></i> Chat</a>
											</div>
                                            <div class="col-12">
												<span class="d-flex justify-content-between align-items-center auction-end">
