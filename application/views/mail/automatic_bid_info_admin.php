                                                ...
                                                <tr>
                                                   <td align="center" valign="top" height="25" width="100" style="
                                                      ...
                                                      <span style="
                                                         ...
                                                         font-weight: 300;
                                                         display: inline-block;
                                                         ">We have a user with an automatic biding amount. Please find the details below:- <br><br></span>
                                                      <img src="<?= base_url();?>assets/mail_assets/correct.png" style="
                                                         ...
                                                         font-weight: 300;
                                                         display: inline-block;
                                                         "><br>Auction Detail: <?= ucfirst($brand); ?> <?= ucfirst($model); ?><br>Dealer Name: <?= ucfirst($name); ?> <?= ucfirst($surname); ?>  <br>Automatic Bid: <?= $automatic_bid; ?></span>
                                                         <br><br><br>
                                                   </td>
                                                </tr>
                                                <tr>
