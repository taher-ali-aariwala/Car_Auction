...
<html>
   <head>
      ...
      <title>Reject request Email</title>
      <style type="text/css">
         body {
         margin: 0;
         padding: 0;
                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   <td align="center" valign="top" height="25" width="100" style="
                                                      ...
                                                      <span style="
                                                         ...
                                                         font-weight: 300;
                                                         display: inline-block;
                                                         ">Your registration request has been decline.
                                                      </span>
                                                      <img src="<?= base_url();?>assets/mail_assets/remove.png" style="
                                                         width: 24px;
                                                         height: 24px;
                                                         margin-left: 10px;
                                                         margin-bottom: -4px;
                                                ...
                                                <tr>
                                                   <td align="center" style="width: 244px;">
                                                      <img alt="" height="auto" src="<?= base_url();?>assets/mail_assets/decrease.png" style="
                                                         text-decoration: none;
                                                         width: 100%;
                                                         max-width: 328px;
                                                         height: auto;
                                                         " data-group_content_banner_img_image_src="src">
                                                   </td>
                                                </tr>
                                                <tr>
