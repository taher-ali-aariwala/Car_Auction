                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                   <td align="center" valign="top" height="25" width="100" style="
                                                      ...
                                                      <span style="
                                                         ...
                                                         color: #243c8f;
                                                         font-weight: 300;
                                                         ">Thank you for signing up at Astemotori (car
                                                      auction portal), To get you started,
                                                      please click on the button below to verify
                                                      your account for the first time.</span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                   <td align="center" valign="top" height="25" width="100" style="
                                                      ...
                                                      cursor: text;
                                                      " panel-color="color_table" editor="content" class="relative_index2">
                                                      <a href="<?php echo base_url();?>dealer/verify_account/<?php echo $getuser->id;?>" style="
                                                         background: #243c8f;
                                                         padding: 10px 40px;
                                                         display: inline-block;
                                                         border-radius: 4px;
