<html>
   <head>
      ...
      <title>Automatic Bid Info</title>
      <style type="text/css">
         body {
         margin: 0;
         padding: 0;
                                                ...
                                                <tr>
                                                   <td align="center" valign="top" height="25" width="100" style="
                                                      ...
                                                      <span style="
                                                         ...
                                                         color: #243c8f;
                                                         font-weight: bold;
                                                         "><?= ucfirst($name); ?> <?= ucfirst($surname); ?></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                   <td align="center" valign="top" height="25" width="100" style="
                                                      ...
                                                      <span style="
                                                         ...
                                                         font-weight: 300;
                                                         display: inline-block;
                                                         ">Thanks! For using the Platform, Please find the details below of your biding.<br><br><br>Automatic Bid: <?= $automatic_bid; ?> <br> Auction Detail: <?= ucfirst($brand); ?> <?= ucfirst($model); ?> </span>
                                                         <br><br><br>
                                                         <span style="
                                                         text-decoration: none;
                                                         line-height: 20px;
                                                         ...
                                                         font-weight: 300;
                                                         display: inline-block;
                                                         "><b>NOTE:-</b> You will be notified via mail if your bid amount will be exceeded by another offer.</span>
                                                     <br><br><br>
                                                   </td>
                                                </tr>
                                                <tr>
