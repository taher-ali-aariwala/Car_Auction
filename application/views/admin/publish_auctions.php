				...
				<div class="card-body">
					<div class="item2-gl">
						<div class="item2-gl-nav clearfix mb-4">
							...
							<a href="<?php echo base_url("Admin/get_publish_auction");?>" class="inprogress_auction ml-2 btn btn-primary">In Progress</a>
						...
						<div class="table-responsive data-table text-center">
							<table id="example2" class="hover table-bordered border-top-0 border-bottom-0" >
                              ...
                              <?php  $i++; ?>
                                        ...
                                        <td><span class="status-icon bg-success"></span><?= $auction->status; ?></td>
