				...
				<div class="card-body">
					<div class="item2-gl">
						<div class="item2-gl-nav clearfix mb-4">
							...
							<a href="<?php echo base_url("Admin/get_new_auction");?>" class="outstanding_auction ml-2 btn btn-primary">Outstanding</a>
							</div>
						</div>
						<div class="table-responsive data-table text-center">
							<table id="example2" class="hover table-bordered border-top-0 border-bottom-0" >
                              ...
                              <td class="text-center"><a href="<?=base_url(); ?>website/auction_details/<?=$auction->id;?>" class="btn btn-primary btn-sm"><i class="far fa-eye"></i> Preview </a></td>
									</tr>
								    <?php
                           	}
                              }
