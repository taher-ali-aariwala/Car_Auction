				...
				<div class="card-body">
					<div class="item2-gl">
						<div class="item2-gl-nav clearfix mb-4">
							<h3 class="float-left bg-primary text-white mb-0 fs-18 px-4 py-2 rounded">Registered Dealer</h3>
                            <div class="float-right">
                                <a href="<?php echo base_url("Admin/online_dealer_list");?>"  class="position-relative inprogress_auction ml-2 btn btn-outline-primary">Online Dealers List
                                </a>
                            </div>
						</div>
                        <?php
