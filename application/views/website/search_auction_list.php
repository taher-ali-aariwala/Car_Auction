			                   ...
			                   foreach($selected_filters['carBrand'] as $bkey =>$bvalue){ ?>
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="custom-control-input wfbrand  ajaxfilter ajaxfilter_cross le-checkbox" data-id="<?= $bvalue; ?>"  name="<?= $bvalue; ?>" value="<?= $bvalue; ?>"  style="opacity:1; z-index:5;" checked></div>
			                ...
			                if(!empty($selected_filters['minRegistrationDate'])){ ?>
			                       ...
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="form-control select2  minyeardropdown ajaxfilter ajaxfilter_cross le-checkbox" data-dropminyearid="<?= $selected_filters['minRegistrationDate']; ?>"  name="<?= $selected_filters['minRegistrationDate']; ?>" value="<?= $selected_filters['minRegistrationDate']; ?>"  style="opacity:1; z-index:5;" checked></div>
			                ...
			                if(!empty($selected_filters['maxRegistrationData'])){  ?>
			                       ...
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="form-control select2  maxyeardropdown ajaxfilter ajaxfilter_cross le-checkbox" data-dropmaxyearid="<?=  $selected_filters['maxRegistrationData']; ?>"  name="<?=  $selected_filters['maxRegistrationData']; ?>" value="<?=  $selected_filters['maxRegistrationData']; ?>"  style="opacity:1; z-index:5;" checked></div>
			                ...
			                if(!empty($selected_filters['minMileage'])){ ?>
			                       ...
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="form-control select2  minmileagedropdown ajaxfilter ajaxfilter_cross le-checkbox" data-dropminmileageid="<?= $selected_filters['minMileage']; ?>"  name="<?= $selected_filters['minMileage']; ?>" value="<?= $selected_filters['minMileage']; ?>"  style="opacity:1; z-index:5;" checked></div>
			                ...
			                if(!empty($selected_filters['maxMileage'])){  ?>
			                       ...
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="form-control select2  maxmileagedropdown ajaxfilter ajaxfilter_cross le-checkbox" data-dropmaxmileageid="<?=  $selected_filters['maxMileage']; ?>"  name="<?=  $selected_filters['maxMileage']; ?>" value="<?=  $selected_filters['maxMileage']; ?>"  style="opacity:1; z-index:5;" checked></div>
			                ...
			                if(!empty($selected_filters['minPrice'])){ ?>
			                       ...
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="form-control select2  minpricedropdown ajaxfilter ajaxfilter_cross le-checkbox" data-dropminpriceid="<?= $selected_filters['minPrice']; ?>"  name="<?= $selected_filters['minPrice']; ?>" value="<?= $selected_filters['minPrice']; ?>"  style="opacity:1; z-index:5;" checked></div>
			                ...
			                if(!empty($selected_filters['maxPrice'])){  ?>
			                       ...
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="form-control select2  maxpricedropdown ajaxfilter ajaxfilter_cross le-checkbox" data-dropmaxpriceid="<?=  $selected_filters['maxPrice']; ?>"  name="<?=  $selected_filters['maxPrice']; ?>" value="<?=  $selected_filters['maxPrice']; ?>"  style="opacity:1; z-index:5;" checked></div>
			                   ...
			                   foreach($selected_filters['carBodyType'] as $btkey =>$btvalue){ ?>
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="custom-control-input ajaxfilter ajaxfilter_cross le-checkbox" data-bodytypeid="<?= $btvalue; ?>"  name="<?= $btvalue; ?>" value="<?= $btvalue; ?>"  style="opacity:1; z-index:5;" checked></div>
			                   ...
			                   foreach($selected_filters['carFuelType'] as $ftkey =>$ftvalue){ ?>
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="custom-control-input ajaxfilter ajaxfilter_cross le-checkbox" data-fueltypeid="<?= $ftvalue; ?>"  name="<?= $ftvalue; ?>" value="<?= $ftvalue; ?>"  style="opacity:1; z-index:5;" checked></div>
			                   ...
			                   foreach($selected_filters['carTransmission'] as $tkey =>$tvalue){ ?>
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="custom-control-input ajaxfilter ajaxfilter_cross le-checkbox" data-transmissionid="<?= $tvalue; ?>"  name="<?= $tvalue; ?>" value="<?= $tvalue; ?>"  style="opacity:1; z-index:5;" checked></div>
			                   ...
			                   foreach($selected_filters['carWhereisit'] as $wkey =>$wvalue){ ?>
			                       <li>
            			                <span class="filter-list-wrap mb-3" id="filter-list">
            			                    ...
            			                    <div class="checkdiv position-relative"><input type="checkbox" class="custom-control-input  ajaxfilter_cross le-checkbox" data-whereisitid="<?= $wvalue; ?>"  name="<?= $wvalue; ?>" value="<?= $wvalue; ?>"  style="opacity:1; z-index:5;" checked></div>
...
<script>
$('.ajaxfilter_cross').on('click change', function(){    
