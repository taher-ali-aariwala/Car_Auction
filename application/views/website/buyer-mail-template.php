...
<head>
    ...
    <title>Buyers Mail Template</title>
    <style type='text/css'>
        body {
            margin: 0;
            padding: 0;
        ...
        <tr>
            <td>
                ...
                <table bgcolor='#ffffff' class='content' align='center' cellpadding='0' cellspacing='0' border='0'>
                    <tr>
                        <td bgcolor='#243c8f' class='header'>
                            <table width='70' align='left' border='0' cellpadding='0' cellspacing='0'>
                                <tr>
                                    <td height='70' style='padding: 0 20px 20px 0;'>
                                        <img class='fix' src='assets/images/photos/mail-ico.jpg' width='70' height='70' border='0' alt=''/>
                                    </td>
                                </tr>
                            </table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td valign='top' height='25' width='100' style='font-size: 18px; color: rgb(51, 51, 51); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 120%; cursor: text;' panel-color='color_table' editor='content' class='relative_index2'>
                                                                <span style='text-decoration: none;line-height: 24px;font-size: 20px;color: rgb(51, 51, 51);font-weight: bold;'>Dear Buyers,</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <td valign='top' style='padding-left: 20px; padding-right: 20px;'>
                                                <table width='100%' edit-style='color_table' align='center' border='0' cellspacing='0' cellpadding='0' style='border-bottom :1px solid #e8e8e8;'>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <!-- end space -->
                                                        <tr>
                                                            <td valign='top' height='25' width='100' style='font-size: 16px; color: rgb(136, 136, 136); font-weight: normal; text-align: justify; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 26px; cursor: text;' panel-color='color_table' editor='content' class='relative_index2'>
                                                                We are pleased to confirm your Buyer registration has been successfully approved from our Admin Team. Now you can login as a user, can participate in all active auctions, can save cars / auctions that interest him in his favorites and then bid. We as administrators will insert each car in the auction (inserting photos, videos, descriptions and all data as explained in detail in the file "description of the car at auction".
                                                            </td>
                                                        </tr>
                                                        <!-- start space -->
                                                        <tr>
                                            ...
                                            <td valign='top' style='padding-left: 20px; padding-right: 20px;'>
                                                <table width='100%' edit-style='color_table' align='center' border='0' cellspacing='0' cellpadding='0' style='border-bottom :1px solid #e8e8e8;'>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <!-- end space -->
                                                        <tr>
                                                            <td valign='top' height='25' width='100' style='font-size: 14px; color: rgb(0, 0, 0); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 140%; cursor: text;' panel-color='color_table' editor='content' class='relative_index2'>
                                                                Thanks and Regards,<br>ASTEMOTORI CAR AUCTION 
                                                            </td>
                                                        </tr>
                                                        <!-- start space -->
                                                        <tr>
