    ...
    <section class="sptb pt-9 pb-0">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                                    ...
                                    <div id="thumbcarousel" class="carousel thumbcarousel slide slider-scroll" data-interval="false">
                                        ...
                                        <div class="carousel-inner">
                                                ...
                                                <div class="carousel-item active">
                                                    ...
                                                    ?>
                                                    <div data-target="#carousel" data-slide-to="0" class="thumb"><img src="<?= base_url(); ?>uploads/auction_car/main_image/<?= $media_main->media; ?>" alt="img" class="img-fluid h-100"></div>
                                                    <?php } } ?>
                                                    ...
                                                    ?>
                                                    <div data-target="#carousel" data-slide-to="<?= $j; ?>" class="thumb"><img src="<?= base_url(); ?>uploads/auction_car/slider_photo/<?= $auctionmedia->media; ?>" alt="img" class="img-fluid h-100"></div>
                                                    <?php 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div>
                                                ...
                                                <div class="item  w-100">
                                                    <div class="card">
                                                        <div class="card-body p-2 w-100 h-500">
                                                            <?= $video->video_url;?>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12" id="auction_area">
                    ...
                    <div class="card" id="sticky-sidebar-main">
                        ...
                        <div class="card-body sidebar__inner">
                            ...
                            <div data-timer="<?=$auction->end_auction_time?>" data-id="demo<?=$auction->id;?>" class="countdownpp text-center text-white bg-danger mb-4 btn-lg btn-block fs-16 font-weight-bold">
                                ...
                                <i class="far fa-clock"></i> <span id="demo<?=$auction->id;?>"  value='<?php echo $auction->end_auction_time;?>' class="timer-countdown-rr"></span>
                            ...
                            ?>
                                ...
                                ?>
                                    <div class="input-group sub-input mt-1 mb-4" style="position:relative;">
                                        ...
                                        <input type="number" name="latest_bid" step="100"  class="form-control input-lg " min="<?=$minbid; ?>" value="<?=$minbid; ?>" style="padding-left:30px" required>
                            ...
                            ?>
                                ...
                                <div class="input-group sub-input mt-1 mb-4">
                                    ...
                                    <input type="number" name="automatic_bid" step="100" class="form-control input-lg " min="<?=$dealer_latest_bid; ?>" placeholder="Enter your offer €..." required>
                            ...
                            <?php  } } }else{ ?>
                                ...
                                <div class="input-group sub-input mt-1 mb-4">
                                    ...
                                    <input type="number"  step="100" class="form-control input-lg" placeholder="Enter your offer €..." required>
                ...
                <div class="container-fluid px-6">
                    <div class="row">
                        ...
                        <div id="" class="owl-carousel owl-carousel-auction-expire">
                            ...
                            <div data-timer="<?=$auction->end_auction_time?>" data-id="demo<?=$auction->id;?>" class="countdownpp item">
                                            ...
                                            <div class="card-body pt-6">
                                                ...
                                                <div class="item-card9-footer d-sm-flex">
                                                    <div class="text-left clearfix w-100">
                                                        <span class="mt-1 mb-1 float-left mr-6" title="FuealType"><i class="fas fa-tachometer-alt fa-2x text-muted mr-1"></i><h6 class="mt-3"><?= $auction->mileage; ?> Km</h6></span>
